Distinct Integers With Target Sum
-----------------------------------
...
The above "targeted sum" task is known as "subset sum problem" or NP class of problems.

I've implemented brute-force (naive) solutuion to solve the task. Look at `subset_sum` function of `main.py`.
The running time is of order O(N*2^N)


I had not enough time to implement more efficient algorithm.
